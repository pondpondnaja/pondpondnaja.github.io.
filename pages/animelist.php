...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="animelist.php">Anime Sub-thai<span class="sr-only">(current)</span></a>
                </li>
            </ul>
                    ...
                    <div class="col-12 col-md-12 col-lg-12 text-center">
                        ...
                        <div style="margin-bottom:20px;overflow-x:hidden;">
                            <div class="fb-page" data-href="https://www.facebook.com/utgfansub/" data-tabs="timeline"
                                data-width="" data-height="70" data-small-header="false"
    ...
    <footer id="sticky-footer" class="page-footer py-4 text-black-100" style="background-color: #ffa1f7;">
